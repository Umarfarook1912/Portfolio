            ...
            <Container className="relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-2 lg:order-1 text-center lg:text-left">
                        ...
                        <h2 className="text-xl sm:text-2xl md:text-3xl text-[#169b46] font-semibold mb-6">
                            {data.title}
                        </h2>
                        <p className="text-sm sm:text-base md:text-lg text-gray-600 mb-8 md:mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0">
                            {data.description}
                        </p>
                        ...
                        <div className="flex flex-wrap gap-3 sm:gap-4 justify-center lg:justify-start">
                            <a
                                ...
                                className="inline-flex items-center px-5 sm:px-8 py-3 sm:py-3.5 text-sm sm:text-base bg-[#169b46] hover:bg-[#50ca71] text-white rounded-full font-semibold transition-all duration-300 shadow-lg shadow-green-200 hover:shadow-xl hover:shadow-green-300 transform hover:-translate-y-0.5"
                            >
                            ...
                            <a
                                href="#projects"
                                className="inline-flex items-center px-5 sm:px-8 py-3 sm:py-3.5 text-sm sm:text-base bg-white hover:bg-gray-50 text-gray-800 rounded-full font-semibold transition-all duration-300 shadow-md hover:shadow-lg border border-gray-200 transform hover:-translate-y-0.5"
                            >
                                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
                        <div className="relative w-64 sm:w-80 md:w-full max-w-md lg:max-w-lg">
